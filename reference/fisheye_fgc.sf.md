...
applies a **focus–glue–context** fisheye to vector data: it (1) ensures
a sensible projected working CRS, (2) **normalizes** coordinates around
a chosen center, (3) calls
[`fisheye_fgc()`](https://alex-nguyen-vn.github.io/mapycusmaximus/reference/fisheye_fgc.md)
